...
```bash
bun create next-app -e "https://github.com/adityadeshlahre/og-assignment" <project-name>

npx create-next-app -e "https://github.com/adityadeshlahre/og-assignment" <project-name>
```
...
```bash
degit adityadeshlahre/og-assignment <project-name>
# using GH cli
gh repo create <project-name> --template <adityadeshlahre>/<og-assignment> --public
